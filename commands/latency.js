...
module.exports = {
	...
	async execute(interaction) {
		if (interaction._subcommand == 'websocket') {
		...
		else if (interaction._subcommand == 'roundtrip') {
			const sent = await interaction.reply({ content: 'Checking the roundtrip latency of the bot!', fetchReply: true });
